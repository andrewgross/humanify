...
import type { SplitPlan, SplitStats, Cluster } from "./types.js";
...
describe("canonicalizePlan", () => {
  ...
  it("serializes Maps with sorted keys", () => {
    const plan = makePlan();
    plan.ledger.entries.set("z:1:Fn", { id: "z:1:Fn", node: {} as any, type: "Fn", source: "z" });
    plan.ledger.entries.set("a:1:Fn", { id: "a:1:Fn", node: {} as any, type: "Fn", source: "a" });
