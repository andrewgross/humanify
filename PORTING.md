...
| analysis/analysis-cache.ts            |    82 | UNASSIGNED |             | not-started |          |
| rename/name-contention.ts             |    56 | UNASSIGNED |             | not-started |          |
| rename/library-prefix-resolver.ts     |    48 | UNASSIGNED |             | not-started |          |
| rename/prior-match-map.ts             |    46 | UNASSIGNED |             | not-started |          |
| rename/run-config.ts                  |    39 | UNASSIGNED |             | not-started |          |
| rename/graph-closure.ts               |    38 | UNASSIGNED |             | not-started |          |
